...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.switchbutton = QPushButton('Switch to Question Mode')
        self.switchbutton.pressed.connect(self.switchWindow)
        

        layout1.addWidget(self.canvas)
        layout1.addWidget(self.animbutton)
        layout1.addWidget(self.switchbutton)

...
class MathsCalculations:
    def __init__(self, V, TH, E, T, G, X, Y):
        self.velo = V
        self.anglep = TH
        self.elev = E
        self.time = T
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.xposinp_qm = QLabel("Enter your x position:")
        self.xposlabel_qm = QLineEdit(self)

        self.yposinp_qm = QLabel("Enter your y position:")
        self.yposlabel_qm = QLineEdit(self)
        ...
        input_layout.addWidget(self.xposlabel_qm)
        input_layout.addWidget(self.xposinp_qm)
        input_layout.addWidget(self.yposlabel_qm)
        input_layout.addWidget(self.yposinp_qm)
